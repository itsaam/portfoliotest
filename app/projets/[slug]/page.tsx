...
// Définition du type pour les paramètres de la page
...
// Données des projets (à déplacer dans un fichier séparé dans un projet réel)
...
export default function ProjectPage({ params }: ProjectPageParams) {
  ...
  if (!project) {
    return <div className="container py-20 text-center">Projet non trouvé</div>;
  }
